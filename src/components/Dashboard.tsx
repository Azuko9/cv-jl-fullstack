...
import { Experience, Competence, DisplayExperience } from '@/types';
...
const Dashboard = ({ experiences: initialData = [], competences = [] }: DashboardProps) => {
            ...
            <section className="relative group overflow-hidden rounded-[3rem] shadow-2xl transition-all duration-500">
              <div className="relative bg-slate-900 text-white p-10 md:p-16">
                <div className="relative z-10 space-y-8">
                  ...
                  <p className="text-2xl md:text-3xl lg:text-4xl leading-tight font-light italic">"Fort de 11 ans en relation client, je mets mon <span className="text-blue-400 font-bold">esprit logique</span> et ma <span className="text-blue-400 font-bold">maîtrise SQL</span> au service du Pôle Fonctionnel d'Octime."</p>
